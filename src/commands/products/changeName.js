...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('change-name')
    .setDescription('Cambia el nombre de un producto.')
    ...
    .addStringOption((opt) =>
      opt.setName('name').setDescription('Nuevo nombre').setRequired(true)
    ),
  ...
  async execute(interaction) {
    ...
    const updated = productsStore.update(productId, { name });
